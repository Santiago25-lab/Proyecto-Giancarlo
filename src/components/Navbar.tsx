      ...
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        ...
        <div ref={ctaRef} className="flex items-center gap-3">
          ...
          <a
            ...
            className="px-4 py-2 flex items-center gap-2 bg-[#25D366] text-white text-xs font-bold rounded-full hover:bg-[#128C7E] transition-all duration-300 shadow-lg hover:shadow-xl hover:-translate-y-0.5"
          >
